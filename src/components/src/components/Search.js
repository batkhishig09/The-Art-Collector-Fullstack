...
const Search = (props) => {
 ...
 const {setIsLoading, setSearchResults } = props;
  ...
  useEffect(() => {
         ...
         .then(([centuriesData, classificationsData]) => {
          setCenturyList(centuriesData);
          setClassificationList(classificationsData)
         })
         .catch((error) => {
          console.log(error)
         });
  ...
  return <form id="search" onSubmit={async (event) => {
    ...
    <fieldset>
      ...
      <input
        ...
        value={ queryString}
        // /* this should update the value of the query string */ calling setQueryString
